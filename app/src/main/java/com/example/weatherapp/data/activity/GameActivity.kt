...
class GameActivity : AppCompatActivity(), Animation.AnimationListener {
     ...
     * */
    val prizes = arrayOf<Food>( Food(1,"Đi chơi với người yêu"),
        Food(2,"Đi vay nợ"),
        Food(3,"Xuất Hành"),
        Food(4,"Trả Nợ"),
        Food(5,"Hết tiền thì ở nhà đi"),
        Food(6,"Ngủ"),
        Food(7,"Code Android"),
        Food(8,"Xem phim"),
        Food(9,"Tương tư Crush"),
        Food(10,"Nấu Ăn"),
        Food(11,"Ăn Chực"),
        Food(12,"Khẩu nghiệp")
    )
    ...
    fun startSpinner() {
        ...
        prizeText = "Bạn nên : ${prizes[prizeIndex].name}"
